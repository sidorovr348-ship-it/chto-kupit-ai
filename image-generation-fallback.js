...
s = s.replace("const e=Error(errors.join(' | ')||'AI provider is not configured');e.status=502;throw e", "const e=Error(errors.join(' | ')||'AI provider is not configured');e.status=502;throw e");
